...
ord_soumet jobscript.sh -mach eccc-ppp3 -cpus 1x1x1 -cm 32G -w ${WTIME} -mpi -jn colin_serial -listing /space/hall3/sitestore/eccc/aq/r1/cle001/src/hierarchical-clustering/listings
